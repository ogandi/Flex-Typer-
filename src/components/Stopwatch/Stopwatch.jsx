...
export default function Stopwatch({setWPM, timeElapsed, setTimeElapsed, isUserTyping, characterCount, setIsUserTyping, userTyped}) {
    let initialTime = 60
    ...
    useEffect(() => {
        ...
        if (isUserTyping) {
            ...
            // const remainingCharacters = characterCount - userTyped
